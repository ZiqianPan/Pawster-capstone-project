...
export default function ShelterStartingScreen() {
    ...
    const getPets = async () => {
      await axios.get(`https://pawsterdatabase.onrender.com/pets`).then((res) => {
        const data = res.data
        console.log(data)
        setPets(data)
    ...
    const getShelters = async () => {
      await axios.get(`https://pawsterdatabase.onrender.com/shelters`).then((res) => {
        const data = res.data
        console.log(data)
        setShelterInfo(data)
      }).catch((c) => console.warn("catch", c));
    ...
    const getUsers = async () => {
      await axios.get(`https://pawsterdatabase.onrender.com/users`).then((res) => {
        const data = res.data
        console.log(data)
        setUsersData(data)
      }).catch((c) => console.warn("catch", c));
